namespace IQB.CustomControl
{
    ...
    public class DatePickerButton : Button
    {
        ...
        public static readonly BindableProperty DateProperty = BindableProperty.Create<DatePickerButton, DateTime?>(p => p.Date, null);
        ...
        public static readonly BindableProperty TextFormatProperty = BindableProperty.Create<DatePickerButton, string>(p => p.TextFormat, "MM'/'dd'/'yyyy");
